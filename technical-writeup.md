...
> _"What I cannot create, I do not understand."_ · Richard Feynman, last blackboard at Caltech, February 15, 1988.
...
4. **Safe Zone Anchor Overlap Logic**: To prevent marking videos as disliked due to parsing boundaries, we locate the intersection of liked videos with the scraped activity. The "Safe Zone" represents the timeline where we can reliably assume any video in the activity log that is _not_ in the liked playlist is a disliked video.
